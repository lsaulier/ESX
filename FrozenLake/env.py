...
class MyFrozenLake(Env):
    ...
    #  Input: coordinates (int), previous coordinates (int), hole position (int)
    #  Output: a state (int (list))
    ...
    #  Input: action (int), already chosen new state (int)
    ...
    #  Input: random seed (int), options (dict)
